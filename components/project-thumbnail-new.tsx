    ...
    if (props.isLink == "image-link") {
        return (
            <div className="h-full flex flex-col group">
                ...
                <a className="relative overflow-hidden block group mt-auto bg-[var(--container-bg)] rounded-3xl shadow-[0px_0px_25px_rgba(0,0,0,0.015)] 2xl:shadow-[0px_0px_35px_rgba(0,0,0,0.01)] duration-300" href={props.link} target={props.target}>
        ...
        return (
            <div className="h-full flex flex-col group">
                ...
                <div className="mb-3"></div>
                <div className="relative overflow-hidden block group mt-auto bg-[var(--container-bg)] rounded-3xl shadow-[0px_0px_25px_rgba(0,0,0,0.015)] 2xl:shadow-[0px_0px_35px_rgba(0,0,0,0.01)] duration-300 inline">
                    <Image src={props.imageSrc} alt={props.name} width={1640} height={1228} className="object-cover"/>
                </div>
            </div>
        );
