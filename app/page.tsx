    ...
    <div className="flex items-center justify-center" id="top">
        ...
        <div className="w-full px-10 md:w-2/3 md:px-0 lg:w-[85%] 2xl:w-[80%] mt-28">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-5 gap-y-25">
              ...
              <SlideUp>
                  <ProjectThumbnailNew isLink="coming-soon" link="#" type="UX design, pro-bono" name="Ednoda: Simplify lesson planning for ESL teachers (coming soon)" desc="" imageSrc="/ednoda.png" imageSrcPoster=".png" target="_self"/>
              </SlideUp>
              {/* <SlideUp>
